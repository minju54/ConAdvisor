...
public class JiveScriptBot {
	...
	public JiveScriptReplyBuilder reply(String username, String message, List<String> category) {
		logger.debug("Get reply to [" + username + "] " + message);
		// entityBuilder 다시 재정의
		...
		String analyzedRequestMessage = message;
		logger.info("[analyzedRequestMessage] : " + analyzedRequestMessage);
		...
		logger.debug(">>> [JiveScriptBot] reply: " + replyBuilder.getReplyAsText());
